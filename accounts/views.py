...
def marriage(request):
	if request.method == 'POST':
		...
		marriagecert = request.POST.get('marriagecert')
		...
		email1 = EmailMessage(
            ...
            "Hello " + em.Name + " you have successfully added Your Marriage Data in our system. Please wait for few hours, we have to process your details. THANK YOU",
...
def personal(request):
	if request.method == 'POST':
		...
		Profile = request.POST.get('ProfilePhoto')
		...
		email = "12190039.gcit@rub.edu.bt")
		print(em.email)
		# print(gender)
		print(em.user)
		email1 = EmailMessage(
