...
class UserData(models.Model):
    ...
    profile = models.ImageField(upload_to='image', null= True, blank=True, default='user/user.png', verbose_name='profileimage')
...
class Marriage(models.Model):
	...
	created = models.DateTimeField(auto_now_add=True)
	MarriageCertificate  = models.ForeignKey(UserData , null=True, on_delete= models.CASCADE)
	status = models.BooleanField(default=False)
